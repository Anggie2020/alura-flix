...
const GlobalContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/Anggie2020/alura-flix/categorias"
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/Anggie2020/alura-flix/videos"
    )
      .then((res) => res.json())
  ...
  const deleteVideo = (id) => {
    fetch(
      `https://my-json-server.typicode.com/Anggie2020/alura-flix/videos/${id}`,
      { method: "DELETE" }
    )
      .then((res) => {
        if (!res.ok) {
